...
namespace JwtAutorizacionAutenciacionEnRoles.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterDto registerDto)
        {
            ...
            // VERSION 3
            var registrerResult = await _authService.RegistrerAsync(registerDto);

            if(registrerResult.IsSuceed) 
                return Ok(registrerResult);

            return BadRequest(registrerResult); 
        }
